...
function Companion() {
	...
	return (
		<div className="companion-layout">
			...
			<aside className={`companion-sidebar ${isSidebarOpen ? "open" : ""}`} aria-label="Riwayat obrolan">
				...
				<div className="companion-composer-wrap">
					...
					<form onSubmit={handleSubmit} className="companion-composer">
						<textarea
							...
							disabled={busy}
						/>
						<button type="submit" disabled={busy || !draft.trim()} className="composer-send" aria-label="Kirim pesan">
							<span className="material-symbols-outlined" aria-hidden="true">
								send
							</span>
						</button>
