			...
			<section className="py-section-gap flex flex-col md:flex-row items-center gap-12 min-h-[716px]">
				<div className="flex-1 space-y-stack-md hero-content">
					...
					<p className="font-body-lg text-body-lg text-on-surface-variant max-w-[500px]">
						Pelajari tanda-tanda awal stroke, pahami faktor risiko Anda, dan dapatkan informasi kesehatan yang mudah
						dipahami.
					</p>
					<div className="flex flex-wrap gap-4 pt-4">
						<Link
							to="/kenali-stroke"
							className="bg-primary text-on-primary px-8 py-4 rounded-full font-label-caps text-label-caps tracking-widest hover:shadow-lg transition-all active:scale-95"
						>
							KENALI STROKE
						</Link>
						<Link
							to="/auth/login"
							className="bg-transparent text-secondary border border-outline-variant px-8 py-4 rounded-full font-label-caps text-label-caps tracking-widest hover:bg-secondary/5 transition-all active:scale-95"
						>
							MASUK
						</Link>
					</div>
				...
				<div className="grid md:grid-cols-2 gap-8 items-stretch">
					<div className="bg-surface-container-low p-10 rounded-xl flex flex-col justify-center border border-outline-variant/10">
						...
						<p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
							Setiap menit stroke tidak tertangani, jutaan sel otak mati. Kesadaran akan gejala awal bukan sekadar
							pengetahuan—ini adalah alat penyelamat nyawa yang paling efektif.
						</p>
					</div>
					<div className="bg-on-secondary-fixed text-on-primary-container p-10 rounded-xl flex flex-col justify-center relative overflow-hidden">
						<div className="relative z-10">
							...
							<p className="font-body-md text-body-md opacity-80 leading-relaxed">
								Penanganan medis dini meningkatkan peluang pemulihan fungsional hingga 3x lipat. Kami hadir untuk
								membantu Anda memahami langkah-langkah kritis tersebut sebelum krisis terjadi.
							</p>
						</div>
			...
			<section className="py-section-gap">
				<div className="grid md:grid-cols-4 gap-6 feature-cards-container">
					<div className="glass-card p-8 group hover:bg-primary transition-all duration-500 cursor-pointer rounded-xl feature-card">
						<span className="material-symbols-outlined text-primary group-hover:text-white transition-colors mb-6 text-[32px]">
							visibility
						</span>
						<h4 className="font-headline-md text-[20px] mb-3 group-hover:text-white transition-colors">
							Memahami gejala awal
						</h4>
						<p className="font-caption text-caption text-on-surface-variant group-hover:text-white/80 transition-colors">
							Identifikasi metode F.A.S.T untuk deteksi dini gejala yang sering terabaikan.
						</p>
					</div>
					<div className="glass-card p-8 group hover:bg-primary transition-all duration-500 cursor-pointer rounded-xl feature-card">
						<span className="material-symbols-outlined text-primary group-hover:text-white transition-colors mb-6 text-[32px]">
						...
						<p className="font-caption text-caption text-on-surface-variant group-hover:text-white/80 transition-colors">
							Cek gaya hidup dan riwayat medis yang mempengaruhi risiko kesehatan pembuluh darah.
						</p>
					</div>
					<div className="glass-card p-8 group hover:bg-primary transition-all duration-500 cursor-pointer rounded-xl feature-card">
						<span className="material-symbols-outlined text-primary group-hover:text-white transition-colors mb-6 text-[32px]">
						...
						<h4 className="font-headline-md text-[20px] mb-3 group-hover:text-white transition-colors">
							Belajar tentang stroke
						</h4>
						<p className="font-caption text-caption text-on-surface-variant group-hover:text-white/80 transition-colors">
							Akses literatur medis yang disederhanakan untuk pemahaman orang awam.
						</p>
					</div>
					<div className="bg-primary text-white p-8 group hover:opacity-90 transition-all duration-500 cursor-pointer rounded-xl shadow-lg feature-card">
						<span
							className="material-symbols-outlined text-white mb-6 text-[32px]"
						...
						<p className="font-caption text-caption text-white/80">
							Pendamping cerdas yang siap menjawab pertanyaan kesehatan Anda kapan saja.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="py-section-gap fade-up-section">
				<div className="text-center mb-16">
					...
					<p className="font-body-md text-on-surface-variant">
						Sebuah siklus pemahaman yang berkelanjutan untuk hidup yang lebih sehat.
					</p>
				</div>
				<div className="relative px-gutter steps-container">
					...
					<div className="grid md:grid-cols-4 gap-8 relative z-10">
						<div className="flex flex-col items-center text-center space-y-4 step-item">
							<div className="w-12 h-12 rounded-full bg-white border-2 border-primary flex items-center justify-center font-bold text-primary shadow-sm">
								1
							</div>
						...
						<div className="flex flex-col items-center text-center space-y-4 step-item">
							<div className="w-12 h-12 rounded-full bg-white border-2 border-outline-variant flex items-center justify-center font-bold text-outline-variant shadow-sm">
								2
							</div>
							<h5 className="font-label-caps text-label-caps tracking-widest text-on-surface-variant">PAHAMI</h5>
							<p className="font-caption text-caption text-on-surface-variant">
								Mengerti apa yang terjadi pada sistem syaraf.
							</p>
						</div>
						<div className="flex flex-col items-center text-center space-y-4 step-item">
							<div className="w-12 h-12 rounded-full bg-white border-2 border-outline-variant flex items-center justify-center font-bold text-outline-variant shadow-sm">
							...
							<p className="font-caption text-caption text-on-surface-variant">
								Lakukan tindakan pencegahan preventif.
							</p>
						</div>
						<div className="flex flex-col items-center text-center space-y-4 step-item">
							<div className="w-12 h-12 rounded-full bg-white border-2 border-outline-variant flex items-center justify-center font-bold text-outline-variant shadow-sm">
							...
							<p className="font-caption text-caption text-on-surface-variant">
								Respon cepat saat keadaan darurat medis.
							</p>
						</div>
					</div>
				</div>
